 ...
 * Appboy's default procedure for the user action.
 */
public interface IContentCardsActionListener {
   ...
   * Appboy will continue its typical handling of the ContentCard click.
   */
  boolean onContentCardClicked(Context context, Card card, IAction cardAction);
