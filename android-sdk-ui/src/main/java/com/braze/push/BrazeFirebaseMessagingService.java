...
public class BrazeFirebaseMessagingService extends FirebaseMessagingService {
   ...
   * forwarded to {@link BrazeFirebaseMessagingService#handleBrazeRemoteMessage(Context, RemoteMessage)}.
   *
   ...
   *         should be passed to {@link BrazeFirebaseMessagingService#handleBrazeRemoteMessage(Context, RemoteMessage)}.
   */
