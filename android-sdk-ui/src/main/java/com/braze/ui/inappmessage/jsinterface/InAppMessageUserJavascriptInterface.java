...
public class InAppMessageUserJavascriptInterface {
  private static final String TAG = BrazeLogger.getBrazeLogTag(InAppMessageUserJavascriptInterface.class);
  ...
  @JavascriptInterface
  public void addToSubscriptionGroup(final String subscriptionGroupId) {
    Braze.getInstance(mContext).getCurrentUser(new SimpleValueCallback<BrazeUser>() {
      @Override
      public void onSuccess(@NonNull BrazeUser currentUser) {
  ...
  @JavascriptInterface
  public void removeFromSubscriptionGroup(final String subscriptionGroupId) {
    Braze.getInstance(mContext).getCurrentUser(new SimpleValueCallback<BrazeUser>() {
      @Override
      public void onSuccess(@NonNull BrazeUser currentUser) {
        currentUser.removeFromSubscriptionGroup(subscriptionGroupId);
      }
    });
  }
