...
public class BackgroundInAppMessagePreparer {
   ...
   *                          call {@link BrazeInAppMessageManager#displayInAppMessage(IInAppMessage, boolean)}
  ...
  static boolean prepareInAppMessageWithZippedAssetHtml(IInAppMessageZippedAssetHtml inAppMessageHtml) {
    ...
    Context applicationContext = BrazeInAppMessageManager.getInstance().getApplicationContext();
