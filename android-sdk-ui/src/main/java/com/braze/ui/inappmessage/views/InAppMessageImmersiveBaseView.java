...
public abstract class InAppMessageImmersiveBaseView extends InAppMessageBaseView implements IInAppMessageImmersiveView {
  ...
  public InAppMessageImmersiveBaseView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }
  ...
  public void setLargerCloseButtonClickArea(final View closeButtonView) {
    ...
    if (closeButtonView.getParent() instanceof View) {
      ((View) closeButtonView.getParent()).post(() -> {
        ...
        final int desiredCloseButtonClickAreaWidth = getContext().getResources().getDimensionPixelSize(R.dimen.com_braze_inappmessage_close_button_click_area_width);
        final int desiredCloseButtonClickAreaHeight = getContext().getResources().getDimensionPixelSize(R.dimen.com_braze_inappmessage_close_button_click_area_height);
