...
public class InAppMessageFullView extends InAppMessageImmersiveBaseView {
  ...
  public InAppMessageFullView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public void createAppropriateViews(Activity activity, IInAppMessageImmersive inAppMessage, boolean isGraphic) {
    mInAppMessageImageView = findViewById(R.id.com_braze_inappmessage_full_imageview);
  ...
  public void setMessageBackgroundColor(int color) {
    if (getMessageBackgroundObject().getBackground() instanceof GradientDrawable) {
      ...
      if (mIsGraphic) {
        ...
        InAppMessageViewUtils.setViewBackgroundColor(findViewById(R.id.com_braze_inappmessage_full_all_content_parent), color);
        InAppMessageViewUtils.setViewBackgroundColor(findViewById(R.id.com_braze_inappmessage_full_text_and_button_content_parent), color);
      }
    }
  }
  ...
  public List<View> getMessageButtonViews(int numButtons) {
    ...
    if (numButtons == 1) {
      ...
      View singleButton = findViewById(R.id.com_braze_inappmessage_full_button_single_one);
      ...
      View dualButton1 = findViewById(R.id.com_braze_inappmessage_full_button_dual_one);
      View dualButton2 = findViewById(R.id.com_braze_inappmessage_full_button_dual_two);
      if (dualButton1 != null) {
  ...
  public TextView getMessageTextView() {
    return findViewById(R.id.com_braze_inappmessage_full_message);
  }

  @Override
  public TextView getMessageHeaderTextView() {
    return findViewById(R.id.com_braze_inappmessage_full_header_text);
  }
  ...
  public void resetMessageMargins(boolean imageRetrievalSuccessful) {
    ...
    View scrollViewChild = findViewById(R.id.com_braze_inappmessage_full_text_layout);
  ...
  public void applyWindowInsets(@NonNull WindowInsetsCompat insets) {
    ...
    if (mIsGraphic) {
      ...
      View contentArea = findViewById(R.id.com_braze_inappmessage_full_text_and_button_content_parent);
      if (contentArea != null) {
  ...
  public int getLongEdge() {
    View inAppMessageFullView = findViewById(R.id.com_braze_inappmessage_full);
  ...
  private void setInAppMessageImageViewAttributes(Activity activity, IInAppMessageImmersive inAppMessage, IInAppMessageImageView inAppMessageImageView) {
    ...
    if (ViewUtils.isRunningOnTablet(activity)) {
      float radiusInPx = (float) ViewUtils.convertDpToPixels(activity, BrazeInAppMessageParams.getModalizedImageRadiusDp());
