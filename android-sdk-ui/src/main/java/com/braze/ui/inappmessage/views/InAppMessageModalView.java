...
public class InAppMessageModalView extends InAppMessageImmersiveBaseView {
  private static final String TAG = BrazeLogger.getBrazeLogTag(InAppMessageModalView.class);
  private InAppMessageImageView mInAppMessageImageView;
  private InAppMessageModal mInAppMessage;

  public InAppMessageModalView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public void applyInAppMessageParameters(Context context, InAppMessageModal inAppMessage) {
    mInAppMessage = inAppMessage;
    mInAppMessageImageView = findViewById(R.id.com_braze_inappmessage_modal_imageview);
  ...
  public void resetMessageMargins(boolean imageRetrievalSuccessful) {
    ...
    RelativeLayout imageLayout = findViewById(R.id.com_braze_inappmessage_modal_image_layout);
    ...
    View scrollViewChild = findViewById(R.id.com_braze_inappmessage_modal_text_layout);
  ...
  public void setMessageBackgroundColor(int color) {
    InAppMessageViewUtils.setViewBackgroundColorFilter(findViewById(R.id.com_braze_inappmessage_modal), color);
  }
  ...
  public List<View> getMessageButtonViews(int numButtons) {
    ...
    if (numButtons == 1) {
      View singleButtonParent = findViewById(R.id.com_braze_inappmessage_modal_button_layout_single);
      if (singleButtonParent != null) {
        singleButtonParent.setVisibility(VISIBLE);
      }

      View singleButton = findViewById(R.id.com_braze_inappmessage_modal_button_single_one);
      if (singleButton != null) {
        buttonViews.add(singleButton);
      }
    } else if (numButtons == 2) {
      View dualButtonParent = findViewById(R.id.com_braze_inappmessage_modal_button_layout_dual);
      if (dualButtonParent != null) {
        dualButtonParent.setVisibility(VISIBLE);
      }

      View dualButton1 = findViewById(R.id.com_braze_inappmessage_modal_button_dual_one);
      View dualButton2 = findViewById(R.id.com_braze_inappmessage_modal_button_dual_two);
      if (dualButton1 != null) {
  ...
  public TextView getMessageTextView() {
    return findViewById(R.id.com_braze_inappmessage_modal_message);
  }

  @Override
  public TextView getMessageHeaderTextView() {
    return findViewById(R.id.com_braze_inappmessage_modal_header_text);
  }
  ...
  public TextView getMessageIconView() {
    return findViewById(R.id.com_braze_inappmessage_modal_icon);
  }
  ...
  private void resizeGraphicFrameIfAppropriate(final Context context, final InAppMessageModal inAppMessage) {
    ...
    final int marginPixels = resources.getDimensionPixelSize(R.dimen.com_braze_inappmessage_modal_margin);
    final int maxModalWidth = resources.getDimensionPixelSize(R.dimen.com_braze_inappmessage_modal_max_width);
    final int maxModalHeight = resources.getDimensionPixelSize(R.dimen.com_braze_inappmessage_modal_max_height);
    ...
    this.post(() -> {
      ...
      final View modalBoundView = findViewById(R.id.com_braze_inappmessage_modal_graphic_bound);
