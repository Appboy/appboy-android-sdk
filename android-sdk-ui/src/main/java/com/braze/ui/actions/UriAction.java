...
public class UriAction implements IAction {
  ...
  protected void openUriWithWebViewActivity(Context context, Uri uri, Bundle extras) {
    ...
    intent.setFlags(BrazeDeeplinkHandler.getInstance().getIntentFlags(IBrazeDeeplinkHandler.IntentFlagPurpose.URI_ACTION_OPEN_WITH_WEBVIEW_ACTIVITY));
    try {
  ...
  protected void openUriWithActionView(Context context, Uri uri, Bundle extras) {
    ...
    intent.setFlags(BrazeDeeplinkHandler.getInstance().getIntentFlags(IBrazeDeeplinkHandler.IntentFlagPurpose.URI_ACTION_OPEN_WITH_ACTION_VIEW));
    try {
      context.startActivity(intent);
    } catch (Exception e) {
