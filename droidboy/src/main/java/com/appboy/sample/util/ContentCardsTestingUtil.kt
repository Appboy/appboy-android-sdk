...
class ContentCardsTestingUtil {
  companion object {
    ...
    private fun getNow(): Long {
      return getNowPlusDelta(TimeUnit.MILLISECONDS, 0)
    }

    private fun getNowPlusDelta(deltaUnits: TimeUnit, delta: Long): Long {
      return System.currentTimeMillis() + deltaUnits.toMillis(delta)
    }
