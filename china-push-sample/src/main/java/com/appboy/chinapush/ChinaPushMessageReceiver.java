 ...
 * events for display in the app's message log. We also register the Baidu user with Braze when
 * the service binds and log notification clicks to Braze when notifications are clicked.
 */
public class ChinaPushMessageReceiver extends PushMessageReceiver {
  ...
  /**
   * Baidu tags are used to segment users. However, Braze does not use Baidu tags,
