...
public class MessagingUtils {
  private static final String TAG = BrazeLogger.getBrazeLogTag(MessagingUtils.class);
  ...
  public static boolean sendInAppMessageReceivedMessage(String unityGameObjectName, String unityCallbackFunctionName, IInAppMessage inAppMessage) {
    if (StringUtils.isNullOrBlank(unityGameObjectName)) {
      BrazeLogger.d(TAG, "There is no Unity GameObject registered in the braze.xml configuration file to receive "
          + "in app messages. Not sending the message to the Unity Player.");
      return false;
    }
    if (StringUtils.isNullOrBlank(unityCallbackFunctionName)) {
      BrazeLogger.d(TAG, "There is no Unity callback method name registered to receive in app messages in "
          + "the braze.xml configuration file. Not sending the message to the Unity Player.");
      return false;
    }
    BrazeLogger.d(TAG, "Sending a message to " + unityGameObjectName + ":" + unityCallbackFunctionName + ".");
  ...
  public static boolean sendPushMessageToUnity(@Nullable String unityGameObjectName, @Nullable String unityCallbackFunctionName, @NonNull Intent pushIntent, @NonNull String pushAction) {
    ...
    if (StringUtils.isNullOrBlank(unityCallbackFunctionName)) {
      BrazeLogger.d(TAG, "There is no Unity callback method name registered to receive " + pushAction + " messages in "
          + "the braze.xml configuration file. Not sending the message to the Unity Player.");
      return false;
    }
    BrazeLogger.v(TAG, "Sending a " + pushAction + " message to " + unityGameObjectName + ":" + unityCallbackFunctionName + ".");
  ...
  public static boolean sendFeedUpdatedEventToUnity(@Nullable String unityGameObjectName,
    ...
    if (StringUtils.isNullOrBlank(unityGameObjectName)) {
      BrazeLogger.d(TAG, "There is no Unity GameObject registered in the braze.xml configuration "
          + "file to receive feed updates. Not sending the message to the Unity Player.");
      return false;
    }
    if (StringUtils.isNullOrBlank(unityCallbackFunctionName)) {
      BrazeLogger.d(TAG, "There is no Unity callback method name registered to receive feed updates in "
          + "the braze.xml configuration file. Not sending the message to the Unity Player.");
      return false;
    }
    ...
    try {
      ...
      BrazeLogger.e(TAG, "Caught exception creating feed updated event Json.", e);
    }
    BrazeLogger.v(TAG, "Sending a feed updated event message to " + unityGameObjectName + ":" + unityCallbackFunctionName + ".");
  ...
  public static boolean sendContentCardsUpdatedEventToUnity(@Nullable String unityGameObjectName,
    ...
    if (StringUtils.isNullOrBlank(unityGameObjectName)) {
      BrazeLogger.d(TAG, "There is no Unity GameObject registered in the braze.xml configuration file "
          + "to receive Content Cards updated event messages. Not sending the message to the Unity Player.");
      return false;
    }
    if (StringUtils.isNullOrBlank(unityCallbackFunctionName)) {
      BrazeLogger.d(TAG, "There is no Unity callback method name registered to receive Content "
    ...
    try {
      ...
      BrazeLogger.e(TAG, "Caught exception creating Content Cards updated event Json.", e);
    }
    BrazeLogger.v(TAG, "Sending a Content Cards update message to " + unityGameObjectName + ":" + unityCallbackFunctionName + ".");
    UnityPlayer.UnitySendMessage(unityGameObjectName, unityCallbackFunctionName, object.toString());
    return true;
  }
